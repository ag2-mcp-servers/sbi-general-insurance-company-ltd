...
class CertificateParameters(BaseModel):
    UDF1: str = Field(..., description='Policy No', examples=['0000001234567890-001'])
    UDF2: str = Field(
        ...,
        description='Verification Value',
        examples=[
            'For Motor- Enter Last 5 Digits of Engine/Chasis No. Or Full RegNo - For Others- Enter Mobile No.'
        ],
    )
